      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-[1.08fr_0.92fr] lg:px-8">
        <div>
          ...
          <div className="mt-6 max-w-2xl rounded-md border border-blue-100 bg-blue-50 p-4">
            ...
            <p className="mt-2 text-sm font-semibold text-slate-800">Founded by Othniel Obasi.</p>
          </div>
...
function Footer() {
  return <footer className="border-t border-slate-200 bg-white py-10"><div className="mx-auto flex max-w-7xl flex-col gap-6 px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8"><div className="flex items-center gap-3"><div className="flex h-10 w-10 items-center justify-center rounded-md bg-blue-950 text-white"><Icon name="network" className="h-5 w-5" /></div><div><p className="font-bold text-slate-950">UK Sovereign AI Product Validation Network</p><p className="text-sm text-slate-500">Trusted AI adoption. Evidence before deployment. Founded by Othniel Obasi.</p></div></div><div className="flex flex-wrap gap-4 text-sm text-slate-500"><a href="#problem" className="hover:text-blue-950">Case</a><a href="#why-now" className="hover:text-blue-950">Why now</a><a href="#model" className="hover:text-blue-950">Model</a><a href="#framework" className="hover:text-blue-950">Framework</a><a href={conceptNoteHref} download className="hover:text-blue-950">Download PDF</a><a href="#contact" className="hover:text-blue-950">Contact</a></div></div></footer>;
}
